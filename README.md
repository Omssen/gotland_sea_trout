# Gotland Sea Trout v6.1.11 – Testversion
...
- v6.1.11 ist eine **Testversion**. Strömung und Wind werden statisch aus interpolierten Modelldaten dargestellt. Die feinere Darstellung an der Küste erzeugt keine zusätzliche physikalische Modellauflösung.
